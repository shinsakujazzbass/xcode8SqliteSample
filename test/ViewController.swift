...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let path = paths[0].stringByAppendingString("test2.db")
        ...
        // insert data
        let sql3 = "INSERT INTO sample (user_id, user_name) VALUES (?, ?);"
        db.executeUpdate(sql3, withArgumentsInArray: [3, "小林新作"])
